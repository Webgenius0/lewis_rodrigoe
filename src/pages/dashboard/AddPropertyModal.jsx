...
import Servicebtn from "@/components/shared/Servicebtn";
...
const AddPropertyModal = ({ visible, onClose }) => {
  ...
  return (
    <>
      ...
      >
        <section className="bg-cover bg-no-repeat bg-center min-h-screen w-full flex items-center justify-center auth-section">
              ...
              <div className="px-7 md:px-[40px] py-[40px] rounded-[48px] bg-[#FFF] w-full sm:max-w-xl md:min-w-[530px] mx-auto white-input">
                <div className="form-header flex flex-col gap-2 items-center">
                  ...
                  <p className="text-[#3B3B3B] text-center font-[Urbanist] text-[15px] md:text-[16px] not-italic font-normal leading-[27.2px]">
                    Our Standard Service Plan is designed for homeowners who
                    want a reliable and cost-effective solution without
                      ...
                      <div className="flex flex-col md:flex-row gap-2 md:gap-4">
                        ...
                        <div className="w-full">
                          ...
                          <Controller
                            ...
                            control={control}
                            rules={{
                              required: "Last Serviced Date is required",
                            }}
                            render={({ field }) => (
                              <input
                                {...field}
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
              ...
              <div className="text-center px-6 py-2">
                ...
                <p className="text-gray-700 text-sm mt-2">
                  Your job gets priority listing to local plumbers ensuring
                  faster responses at a fair price.
                </p>
              </div>
