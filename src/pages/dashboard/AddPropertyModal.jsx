    ...
    <>
      ...
      >
        <div className="white-input">
          <div className="px-3 sm:px-4 md:px-[30px] lg:px-[40px] py-[40px] rounded-[48px] bg-[#FFF] w-full  mx-auto">
            <div className="form-header flex flex-col gap-2 items-center">
              ...
              <p className="text-[#3B3B3B] text-center font-[Urbanist] text-[15px] md:text-[16px] not-italic font-normal leading-[27.2px]">
                Our Standard Service Plan is designed for homeowners who want a
                reliable and cost-effective solution without compromising on
                quality.
              </p>
            </div>
            <form
